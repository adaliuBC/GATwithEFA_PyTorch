...
As Na+ ion channel and K+ ion channel are important in the generation of action potentials, these two ion channels are modeled as the two variable resistances $$R_{Na}$$ and $$R_K$$ in parallel on the right side of the circuit diagram, and the resistance $$R$$ refers to all the non-specific ion channels on the membrane. The batteries $$E_{Na}$$, $$E_K$$ and $E\_L$ refer to the electric potential differences caused by the concentration differences of corresponding ions.
...
![png](https://github.com/adaliuBC/GATwithEFA_PyTorch/tree/208d72db158e2f0d5a9c08b464ca95f2706f5957/brainpy_handbook/figs/neus/codes/HH1.PNG)

![png](https://github.com/adaliuBC/GATwithEFA_PyTorch/tree/208d72db158e2f0d5a9c08b464ca95f2706f5957/brainpy_handbook/figs/neus/codes/HH2.PNG)
